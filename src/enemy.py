...
class Enemy(pygame.sprite.Sprite):
    ...
    def apply_gravity(self, dt):
        if not self.on_ground:
            ...
            self.player_hitbox_rect.y = self.rect.y
        else:
            self.direction.y = 0
...
class Enemy3(Enemy):
    def __init__(self, pos, images, collision_sprites):
        ...
        self.hitbox_rect.size = (180, 190)  # Ajustar el tamaño de la hitbox
        self.player_hitbox_rect.size = (120, 150)  # Ajustar el tamaño de la hitbox de colisión con el jugador
        self.jump_force = -360  # Fuerza del salto, ajusta según sea necesario
        self.speed = 150
